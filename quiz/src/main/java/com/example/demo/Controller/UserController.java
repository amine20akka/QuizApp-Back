...
import com.example.demo.Entity.AuthenticationRequestDTO;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> authenticateUser(@RequestBody AuthenticationRequestDTO authenticationRequestDTO) {
        try {
